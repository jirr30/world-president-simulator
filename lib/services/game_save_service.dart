...
class GameSaveService {
  ...
  static Future<void> save(GameStateModel state) async {
    ...
    final map = {
      ...
      'populationMillions': state.populationMillions,
      'healthcareBudget': state.healthcareBudget,
      'educationBudget': state.educationBudget,
  ...
  static Future<GameStateModel?> load() async {
    ...
    try {
      ...
      return GameStateModel(
        ...
        warProgress: (map['warProgress'] as num?)?.toDouble() ?? 0.0,
        ...
        populationMillions: (map['populationMillions'] as num?)?.toDouble() ?? 0.0,
        healthcareBudget: (map['healthcareBudget'] as num?)?.toDouble() ?? 0.0,
        educationBudget: (map['educationBudget'] as num?)?.toDouble() ?? 0.0,
